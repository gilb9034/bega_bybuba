      ...
      <div className="Main_div">
        <div className="container">
              ...
              <div className="card  mt-4 mt-md-4">
                <div className="card-body text-center">
                  <div className="d-flex flex-column justify-content-center mt-4">
                    <h1 className=' fw-bolder'>Your $BeGa Balance</h1>
          ...
          <div className=" mt-5 logoMaindiv2 pb-2 d-flex justify-content-center align-items-center">
            ...
            <a href="https://t.me/beangames"><i className="fab fs-3 marginLeft fa-telegram-plane"></i></a>
            <a href="https://twitter.com/beangamesbsc"><i className="fab fs-3 marginLeft fa-twitter"></i></a>
          </div>
        </div>
